...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      const formData = new FormData(form); // TO JSON
      // const obj = {};
...
function openModal(modalSelector, modalTimerId) {
  ...
  if (modalTimerId) clearInterval(modalTimerId); // if user has already opened the modal, then don't show it by TimeOut
}
...
function timer(id, deadline) {
  ...
  function getTimeRemaining(endtime) {
    const t = Date.parse(endtime) - new Date(),
          // milliseconds left untill today
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => Object(function webpackMissingModule() { var e = new Error("Cannot find module '.modules/modal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('.modal', modalTimerId), 500000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2021-11-11');
